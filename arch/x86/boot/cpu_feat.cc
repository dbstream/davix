...
PTEFLAGS PTEFLAGS_IOWRITECOMBINE;
PTEFLAGS PTEFLAGS_IOWRITETHROUGH;
PTEFLAGS PTEFLAGS_IOUNCACHED;
EXPORT_SYMBOL(PTEFLAGS_READONLY)
EXPORT_SYMBOL(PTEFLAGS_READWRITE)
EXPORT_SYMBOL(PTEFLAGS_READEXEC)
EXPORT_SYMBOL(PTEFLAGS_IOWRITECOMBINE)
EXPORT_SYMBOL(PTEFLAGS_IOWRITETHROUGH)
EXPORT_SYMBOL(PTEFLAGS_IOUNCACHED)
...
#define cpuid cpuid(a, b, c, d)
	...
	PTEFLAGS_IOWRITECOMBINE = HalMakePTEFlags(PAGE_WRITECOMBINE, 1, 1, 0);
	PTEFLAGS_IOWRITETHROUGH = HalMakePTEFlags(PAGE_WRITETHROUGH, 1, 1, 0);
	PTEFLAGS_IOUNCACHED = HalMakePTEFlags(PAGE_UNCACHED, 1, 1, 0);
}
