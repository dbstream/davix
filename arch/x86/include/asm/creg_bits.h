...
/*
 * File: include/asm/creg_bits.h
 * Bits in control registers.
 *
 * Copyright (C) 2025  dbstream
 *
 * This header file is based on the Intel 64 and IA-32 Architectures Software
 * Developer's Manual, vol. 3, chapter 2.5 "Control Registers" and chapter 2.6
