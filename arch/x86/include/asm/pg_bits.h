...
#define __PG_ADDR_MASK 0x000ffffffffff000UL

#define __KERNEL_PAGE_TABLE (__PG_PRESENT | __PG_WRITE)

#define __USER_PAGE_TABLE (__PG_PRESENT | __PG_WRITE | __PG_USER)
