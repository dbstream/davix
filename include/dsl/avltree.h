...
public:
	 ...
	 */
	inline void insert_at(AVLNode *parent, Dir dir, AVLNode *node)
	{
	 ...
	 */
	inline void remove(AVLNode *node)
	{
...
private:
	...
	Comparator m_cmp;
public:
	constexpr TypedAVLTree(void)
		: m_tree(), m_cmp()
	{}

	constexpr TypedAVLTree(Comparator cmp)
		: m_tree(), m_cmp(cmp)
	{}
	...
	static inline T *container_of(AVLNode *node)
	{
		return ::container_of<T, AVLNode>(F, node);
	}

	static inline const T *const_container_of(const AVLNode *node)
	{
