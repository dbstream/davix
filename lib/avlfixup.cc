...
static inline int new_height(AVLNode *node)
{
 ...
 */
static inline int node_balance(AVLNode *node)
{
 ...
 */
static inline AVLNode *rotate(AVLNode *node, AVLTree::Dir dir)
{
